...
use App\Http\Requests\Recruitment\CreateRecruitmentRequest;
...
class RecruitmentController extends BaseController
{
    ...
    #[OA\Put(
        ...
        summary: 'Update recruitment. ***DONE***',
        security: [['BearerAuth' => []]],
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
                          ref: UpdateRecruitmentRequest::class
                      )
        ),
        tags: ['RECRUITMENTS'],
        responses: [
    ...
    #[OA\Post(
        path: '/recruitments',
        summary: 'Create recruitment. ***DONE***',
        security: [['BearerAuth' => []]],
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
                          ref: CreateRecruitmentRequest::class
                      )
        ),
        tags: ['RECRUITMENTS'],
        responses: [
